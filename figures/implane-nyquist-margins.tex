...
\node[coordinate, pin=225:{\small $|H_o(\mathrm{e}^{i\omega_ch})|=1$}] at (axis cs: \angleatomegac, \gainatomegac) {}; 
\node[coordinate, pin=110:{\small$|H_o(\mathrm{e}^{i\omega_ph})|=\frac{1}{A}$}] at (axis cs: -180, 1) {}; 
